...
public class Particle {
    ...
    public void draw(Graphics graphics, WindowState windowState) {
        int x = (int) ((tilePosition.x + 0.5) * windowState.getTileSize() + windowState.getOffset().getX());
        int y = (int) ((tilePosition.y + 0.5) * windowState.getTileSize() + windowState.getOffset().getY());
