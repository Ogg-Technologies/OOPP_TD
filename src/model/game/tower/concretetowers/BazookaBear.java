...
public class BazookaBear extends AbstractAttackingTower {
    ...
    public BazookaBear(Vector pos, EnemyTargeter enemyTargeter, ProjectileCreator projectileCreator, EventSender eventSender) {
        super(pos, Config.INSTANCE.BAZOOKABEAR.RANGE,
                new ConstantChargeStrategy(Config.INSTANCE.BAZOOKABEAR.ATTACK_DELAY), enemyTargeter);
    ...
    protected void attack(Enemy e) {
        int damage = (int) (Config.INSTANCE.BAZOOKABEAR.BASE_DAMAGE * getActiveMultipliers().getDamageMultiplier());
